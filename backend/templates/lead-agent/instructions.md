...
- Read the full story summary and description provided in context — this may come from Jira or be a manually entered story
- **If Jira returned an error or is not configured, work from the manual story description in the context — do NOT stop or flag this as a blocker**
